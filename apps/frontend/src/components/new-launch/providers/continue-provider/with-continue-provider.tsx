        ...
        <div className="grid grid-cols-3 justify-items-center select-none cursor-pointer gap-[10px]">
          {filteredData.map((item) => (
            <div
              key={getItemId(item)}
              className={clsx(
                'flex flex-col w-full text-center gap-[10px] border border-newTableBorder p-[10px] hover:bg-boxHover rounded-[8px]',
                isSelected(item, selection) && 'bg-boxHover border-forth'
              )}
