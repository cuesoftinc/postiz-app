...
export const HeadingComponent: FC<{
  ...
  return (
    <div className="select-none cursor-pointer rounded-[8px] w-[32px] h-[32px] border border-newTableBorder hover:bg-newTableHeader flex justify-center items-center group relative">
      <svg
