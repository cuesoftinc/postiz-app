...
export const StreakComponent: FC = () => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute -bottom-[4px] -end-[6px] min-w-[16px] h-[16px] px-[3px] rounded-full bg-[#e2d8ff] text-[10px] leading-none font-[550] text-black flex items-center justify-center">
        {streakDays}
      </span>
    </div>
  );
