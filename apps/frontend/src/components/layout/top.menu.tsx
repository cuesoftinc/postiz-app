...
export const useMenuItem = () => {
  ...
  const user = useUser();
  // Claude Code content chat — admin-only surface (route + backend enforce
  // it too); non-admins never see the nav item
  ...
  const firstMenu = [
    ...
    ...(isAdmin
      ? [
          {
            // Buffer's "Create" slot — the Claude content bridge chat
