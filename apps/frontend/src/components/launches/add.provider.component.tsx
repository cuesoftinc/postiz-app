      ...
      <div className="flex flex-col">
        <div
          className={clsx(
            ...
            !isMobile &&
              'grid grid-cols-5 gap-[10px] justify-items-center justify-center phone:grid-cols-2',
            isMobile ? {} : onboarding ? 'grid-cols-9 phone:grid-cols-2' : 'grid-cols-5 phone:grid-cols-2'
          )}
        >
          {social
            .filter((item) => {
