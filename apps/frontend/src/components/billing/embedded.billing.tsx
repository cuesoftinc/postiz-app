...
const AppliedCouponDisplay: FC<{
  ...
  return (
    <div className="flex flex-col gap-[8px]">
      <div className="flex items-center gap-[12px] p-[16px] rounded-[12px] border border-[#325ea6]/30 bg-seventh">
...
const SubmitBar: FC<{ loading: boolean }> = ({ loading }) => {
  ...
  return (
    <div className="animate-fadeIn h-[92px] mobile:h-auto fixed bottom-0 w-full px-[12px] pb-[12px] left-0 bg-newBgColor z-[150]">
